...
-- AddForeignKey
ALTER TABLE "SharedResult" ADD CONSTRAINT "SharedResult_testResultId_fkey" FOREIGN KEY ("testResultId") REFERENCES "TestResult"("id") ON DELETE CASCADE ON UPDATE CASCADE;
