...
interface SharedAuraDisplayProps {
  traits?: {
    openness?: number
...
export default function SharedAuraDisplay({
  traits = {},
  className = '',
}: SharedAuraDisplayProps) {
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at center,
              ${traits.openness ? `hsl(280, ${70 + (traits.openness || 3) * 5}%, ${50 + (traits.openness || 3) * 5}%)` : 'hsl(280, 80%, 60%)'} 0%,
              ${traits.conscientiousness ? `hsl(120, ${70 + (traits.conscientiousness || 3) * 5}%, ${50 + (traits.conscientiousness || 3) * 5}%)` : 'hsl(120, 80%, 60%)'} 35%,
              ${traits.extraversion ? `hsl(210, ${70 + (traits.extraversion || 3) * 5}%, ${50 + (traits.extraversion || 3) * 5}%)` : 'hsl(210, 80%, 60%)'} 70%,
              transparent 100%)`,
          }}
        />
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <motion.h4
              ...
              style={{ color: traits.openness ? `hsl(280, ${70 + (traits.openness || 3) * 5}%, ${50 + (traits.openness || 3) * 5}%)` : 'hsl(280, 80%, 60%)' }}
              animate={{
                color: [
                  traits.openness ? `hsl(280, ${70 + (traits.openness || 3) * 5}%, ${50 + (traits.openness || 3) * 5}%)` : 'hsl(280, 80%, 60%)',
                  traits.conscientiousness ? `hsl(120, ${70 + (traits.conscientiousness || 3) * 5}%, ${50 + (traits.conscientiousness || 3) * 5}%)` : 'hsl(120, 80%, 60%)',
                  traits.extraversion ? `hsl(210, ${70 + (traits.extraversion || 3) * 5}%, ${50 + (traits.extraversion || 3) * 5}%)` : 'hsl(210, 80%, 60%)',
                  traits.openness ? `hsl(280, ${70 + (traits.openness || 3) * 5}%, ${50 + (traits.openness || 3) * 5}%)` : 'hsl(280, 80%, 60%)',
                ]
              }}
